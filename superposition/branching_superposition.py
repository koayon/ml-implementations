"""
Inspired by Toy Models of Superposition, Branching Superposition from Distil and MoE model interpretability.
"""
...
from superposition.models import MoE, ReLUModel
...
for current_sparsity in np.linspace(0, 0.9, num=NUM_SAMPLE_SPARSITIES):
    ...
    model = MoE(
        DIM,
        HIDDEN_DIM,
        experts=[ReLUModel(DIM, HIDDEN_DIM), ReLUModel(DIM, HIDDEN_DIM)],
    )
